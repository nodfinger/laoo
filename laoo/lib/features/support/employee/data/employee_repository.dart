...
class EmployeeRepository {
  ...
  Future<Map<String, bool>> actions({
    bool customer = false,
    bool company = false,
  }) async {
    final path = company
        ? '/api/company/employees/actions'
        : customer
        ? '/api/partner/customer-employees/actions'
        : '/api/partner/employees/actions';
  ...
  Future<void> saveFormalImage(
    ...
    final path =
        '${company
            ...
            : customer
            ? '/api/partner/customer-employees'
            : '/api/partner/employees'}/$id/image';
    await _api.put(
      path,
      body: {
        'imageType': 'FORMAL',
  ...
  Future<void> saveCarImage(
    ...
    final path =
        '${company
            ...
            : customer
            ? '/api/partner/customer-employees'
            : '/api/partner/employees'}/$id/car-image/$carNo';
    await _api.put(
      path,
      body: {
        'carNo': carNo,
  ...
  Future<Map<String, dynamic>?> getFormalImage(
    int id, {
    int? companyId,
    bool customer = false,
    bool company = false,
  ...
  Future<Map<String, dynamic>> getEmployeeUser(
    int id, {
    int? companyId,
    bool customer = false,
    bool company = false,
