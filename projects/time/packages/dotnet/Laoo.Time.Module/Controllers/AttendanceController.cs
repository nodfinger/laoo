...
SELECT E.EmployeeID,E.EmployeeCode,E.FullName,
       ...
       SUM(CASE WHEN R.StatusCode='LEAVE' THEN 1 ELSE 0 END) LeaveDayCount,
       SUM(CASE WHEN R.StatusCode='LEAVE_PARTIAL' THEN 1 ELSE 0 END) PartialLeaveDayCount,
...
""";
        ...
        while (await reader.ReadAsync(token))
        {
            items.Add(new
            {
                ...
                leaveDayCount = reader.GetInt32(6),
                partialLeaveDayCount = reader.GetInt32(7),
                scheduledWorkMinutes = reader.GetInt32(8),
                actualWorkMinutes = reader.GetInt32(9),
                lateMinutes = reader.GetInt32(10),
