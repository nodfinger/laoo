...
public sealed class MeetingStructureController(IConfiguration configuration, IWebHostEnvironment environment) : ControllerBase
{
    ...
    private Task<bool> Allowed(SqlConnection c, string action, CancellationToken t) => LaooMeetingApi.Security.MeetingFoodPlanAccess.Allowed(c, User, action, t, ScreenCode);
