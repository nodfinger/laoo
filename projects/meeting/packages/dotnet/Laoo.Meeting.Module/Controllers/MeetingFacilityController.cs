...
END";
    ...
    private Task<bool> Allowed(SqlConnection c, string action, CancellationToken token) => LaooMeetingApi.Security.MeetingFoodPlanAccess.Allowed(c, User, action, token, ScreenCode);
