...
```powershell
cd C:\laooplatformplatform\laoo\laoo_meeting_api
...
ชุดนี้ใช้ `http://localhost:5080` สำหรับ Development เพื่อหลีกเลี่ยงปัญหา HTTPS Development Certificate บน Flutter Windows
