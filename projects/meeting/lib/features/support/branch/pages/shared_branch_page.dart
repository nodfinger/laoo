...
import '../data/shared_branch_repository.dart';
...
class _BranchPageState extends State<BranchPage> {
  ...
  late final SharedBranchRepository _repository;
  ...
  void initState() {
    ...
    _contract = _scope == LaooOwnerScope.company
        ? _meetingCompanyContract
        : BranchScreenContracts.forScope(_scope);
    _repository = SharedBranchRepository(scope: _scope, api: _api);
