...
class _MasterDataPageState extends State<MasterDataPage> {
              ...
              return Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.symmetric(
                    ...
                    vertical: LaooLayout.captionCardPaddingVertical,
                  ),
                  child: Column(
  ...
  Widget _filterCard(Widget child) => Card(
    margin: EdgeInsets.zero,
    child: Padding(
      padding: const EdgeInsets.all(LaooLayout.cardPadding),
      child: child,
          ...
          Card(
            ...
            child: Column(
              children: [
                ...
                Divider(height: 1, color: LaooColors.border),
              ],
            ),
          ),
          const SizedBox(height: 8),
