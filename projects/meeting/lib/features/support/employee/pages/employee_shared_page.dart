...
import '../../organization/data/shared_organization_repository.dart'
    as local_org;
import '../../presentation/widgets/support_workspace_shell.dart';
import '../data/shared_employee_repository.dart' as local_employee;
...
class _EmployeeUxPageState extends State<EmployeeUxPage> {
  ...
  String _caption = 'เธเธเธฑเธเธเธฒเธ';
  bool _loading = true;
  Object? _loadError;
  ...
  Future<EmployeeImageInput?> _pickImage() async {
    ...
    if (decoded == null) {
      throw StateError(
        'เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธญเนเธฒเธเนเธเธฅเนเธฃเธนเธเธ เธฒเธเนเธ”เน เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธเนเธเธฅเนเนเธซเธกเน',
      );
    }
    var quality = 85;
    ...
    if (bytes.length > 102400) {
      throw StateError(
        'เธฃเธนเธเธ เธฒเธเธกเธตเธเธเธฒเธ”เนเธซเธเนเน€เธเธดเธเนเธเนเธฅเธฐเธฅเธ”เธเธเธฒเธ”เนเธกเนเธชเธณเน€เธฃเนเธ เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธเนเธเธฅเนเธ—เธตเนเน€เธฅเนเธเธเธงเนเธฒ',
      );
    }
          ...
          builder: (dialogContext) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const Text(
                  'เธเนเธญเธกเธนเธฅเธ—เธตเนเธฅเธเนเธฅเนเธงเนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธฃเธตเธขเธเธเธทเธเนเธ”เน',
                ),
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: LaooLayout.cardSpacing),
          Text(
            'เนเธซเธฅเธ”เธเนเธญเธกเธนเธฅเธชเธณเธซเธฃเธฑเธเธซเธเนเธฒเธเธเธฑเธเธเธฒเธเนเธกเนเธชเธณเน€เธฃเนเธ: ${_errorText(_loadError!)}',
            textAlign: TextAlign.center,
          ),
          TextButton.icon(
            onPressed: _loadDependencies,
            icon: const Icon(Icons.refresh),
            label: const Text('เธฅเธญเธเนเธซเธกเน'),
          ),
        ],
      ),
    ),
