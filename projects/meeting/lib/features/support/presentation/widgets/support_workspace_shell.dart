...
import '../../../../core/navigation/menu_icon_resolver.dart';
...
/// Shared full-width surface for page caption, filters, data and pagination.
/// Pages own only their content; spacing and Card presentation stay central.
class WorkspaceSectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    OutlineInputBorder inputBorder(InputBorder? source) => OutlineInputBorder(
      borderRadius: BorderRadius.circular(LaooRadius.xs),
      borderSide: source is OutlineInputBorder
          ? source.borderSide
          : BorderSide(color: base.colorScheme.outlineVariant),
    );
    final sectionTheme = base.copyWith(
      ...
      inputDecorationTheme: base.inputDecorationTheme.copyWith(
        ...
        focusedBorder: inputBorder(base.inputDecorationTheme.focusedBorder),
        errorBorder: inputBorder(base.inputDecorationTheme.errorBorder),
        focusedErrorBorder: inputBorder(
          base.inputDecorationTheme.focusedErrorBorder,
        ),
        disabledBorder: inputBorder(base.inputDecorationTheme.disabledBorder),
      ),
    );
    return Theme(
      data: sectionTheme,
...
/// Standard action-screen caption layout.
///
/// On compact content widths, actions move below the caption and stay
/// left-aligned. This keeps save/cancel actions predictable on every screen.
      ...
      builder: (context, constraints) {
        if (constraints.maxWidth < compactBreakpoint) {
          return Column(
            ...
            children: [
              SizedBox(width: double.infinity, child: titleWidget),
...
class WorkspacePageTitle extends StatefulWidget {
  ...
  @override
  State<WorkspacePageTitle> createState() => _WorkspacePageTitleState();
}
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              preset.surface,
                              Color.alphaBlend(
                                preset.primary.withValues(alpha: .07),
                                preset.surface,
                              ),
                            ],
                          ),
                          border: Border(
                            top: BorderSide(color: preset.primary, width: 3),
                            bottom: BorderSide(color: preset.border),
                          ),
                        ),
                      ),
            ...
            ...groups.map(
              (group) => PopupMenuItem<String>(
                ...
                child: ListTile(
                  contentPadding: EdgeInsets.zero,
                  leading: Icon(
                    _buttonMenuIcon(group.iconName, group.name),
                    color: widget.preset.primary,
                  ),
                  title: Text(
                    group.name,
...
class _TopBar extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final primaryWash = Color.alphaBlend(
      preset.primary.withValues(alpha: .06),
      preset.surface,
    );
    return Container(
      height: 74,
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [preset.surface, primaryWash, preset.surface],
          stops: const [0, .58, 1],
        ),
        border: Border(
          top: BorderSide(color: preset.primary, width: 3),
        ...
        boxShadow: [
          BoxShadow(
            color: preset.primary.withValues(alpha: .06),
            blurRadius: 18,
      ...
      child: Row(
        children: [
          ...
          DecoratedBox(
            decoration: BoxDecoration(
              color: preset.primary.withValues(alpha: .055),
              border: Border.all(color: preset.primary.withValues(alpha: .12)),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  width: 1,
                  height: 26,
                  color: preset.primary.withValues(alpha: .16),
                ),
                _TopBarAction(
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      style: TextButton.styleFrom(
        ...
        overlayColor: color.withValues(alpha: .10),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(LaooRadius.sm),
        ),
      ),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(_buttonMenuIcon(group.iconName, group.name),
                  ...
                  child: Ink(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(
                            _buttonMenuIcon(item.iconName, item.name),
                            size: 30,
                            color: active
                                ? widget.preset.primary
          ...
          children: [
            ...
            GridView.builder(
              ...
              gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                ...
                mainAxisExtent: 96,
                crossAxisSpacing: LaooLayout.cardSpacing,
                mainAxisSpacing: LaooLayout.cardSpacing,
              ),
                    ...
                    child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(
                              _buttonMenuIcon(item.iconName, item.menuName),
                              size: 26,
                              color: widget.preset.primary,
                            ),
...
IconData _buttonMenuIcon(String? name, [String? semanticName]) =>
    MenuIconResolver.resolve(name, semanticName: semanticName);
...
class _FavoriteWorkspaceBarState extends State<_FavoriteWorkspaceBar> {
  ...
  IconData _icon(String? name, [String? semanticName]) =>
      MenuIconResolver.resolve(name, semanticName: semanticName);
        ...
        child: Row(
          children: [
            ...
            ..._favorites.map((item) {
              ...
              final selected = spec?.path == currentPath;
              return Container(
                // Keep each favorite visually separated while retaining the
                // compact menu-bar layout.
                margin: const EdgeInsets.only(right: 6),
                decoration: BoxDecoration(
                  color: accent.withValues(alpha: selected ? .13 : .045),
                  border: Border.all(
                    color: accent.withValues(alpha: selected ? .30 : .12),
                  ),
                  borderRadius: BorderRadius.circular(LaooRadius.sm),
                ),
                child: buttonStyle
                          ...
                          InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    _icon(item.iconName, item.menuName),
                                    size: 18,
                                    color: accent,
                                  ),
                                  const SizedBox(width: 8),
...
class _ThemeButton extends StatelessWidget {
  const _ThemeButton({required this.preset});
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      ...
      style: IconButton.styleFrom(
        backgroundColor: preset.primary.withValues(alpha: .06),
        side: BorderSide(color: preset.primary.withValues(alpha: .16)),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(LaooRadius.sm),
        ),
      ),
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        PopupMenuItem(
          ...
          child: ListTile(
            contentPadding: EdgeInsets.zero,
            leading: Icon(Icons.manage_accounts_outlined, color: accent),
            title: const Text(
              'ข้อมูลส่วนตัว',
...
class _UserMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final accent = darkSurface
        ? Colors.white
        : Theme.of(context).colorScheme.primary;
    const foreground = LaooColors.pageCaption;
    final secondary = LaooColors.pageCaption.withValues(alpha: .62);
      ...
      itemBuilder: (context) => [
        PopupMenuItem(
          ...
          child: ListTile(
            contentPadding: EdgeInsets.zero,
            leading: Icon(Icons.manage_accounts_outlined, color: accent),
            title: Text('ข้อมูลส่วนตัว', style: TextStyle(color: foreground)),
          ),
        ),
        PopupMenuItem(
          value: 'logout',
          child: ListTile(
            contentPadding: EdgeInsets.zero,
            leading: Icon(Icons.logout_rounded, color: accent),
            title: Text('ออกจากระบบ', style: TextStyle(color: foreground)),
          ),
        ),
      ],
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: preset.primary.withValues(alpha: .18)),
          borderRadius: BorderRadius.circular(LaooRadius.sm),
          boxShadow: [
            BoxShadow(
              color: preset.primary.withValues(alpha: .07),
              blurRadius: 14,
...
class _ApiRoleScopedSidebarState extends State<_ApiRoleScopedSidebar> {
                    ...
                    .map(
                      (group) => _MenuGroup(
                        ...
                        children: group.items.map((item) {
                          ...
                          return _MenuItem(
                            label: item.name,
                            icon: _iconFor(item.iconName, item.name),
  ...
  IconData _iconFor(String? name, [String? semanticName]) =>
      MenuIconResolver.resolve(name, semanticName: semanticName);
}
...
class _BrandHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final secondaryColor = compact
        ? LaooColors.pageCaption.withValues(alpha: 0.62)
        : darkSidebar
