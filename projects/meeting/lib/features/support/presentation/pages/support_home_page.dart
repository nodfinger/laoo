                        ...
                        children: [
                          for (final favorite in _favorites)
                            _MobileMenuTile(
                              ...
                              icon: _icon(favorite.iconName, favorite.menuName),
                              size: 80,
                ...
                child: Wrap(
                  ...
                  children: [
                    for (final group in groups)
                      _MobileMenuTile(
                        label: group.name,
                        icon: _icon(group.iconName, group.name),
                        size: 80,
                ...
                child: Wrap(
                  ...
                  children: [
                    for (final item in selected.items)
                      _MobileMenuTile(
                        label: item.name,
                        icon: _icon(item.iconName, item.name),
                        size: 80,
...
class _WorkspaceContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Text('เมนูหลัก', style: LaooTypography.pageCaptionStyle),
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            final columns = width >= 1100
                ...
                ? 2
                : 1;
            const gap = LaooLayout.cardSpacing;
