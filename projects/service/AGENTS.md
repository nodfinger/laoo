...
- รูปสินค้าใหม่ต้องเก็บเป็นไฟล์ที่ API Server ภายใต้ `laoo_service_api/wwwroot/uploads/items/{CompanyID}/{ItemID}` และเก็บ path/metadata ใน `TDIVItemImage`; ห้ามเพิ่ม binary รูปใหม่ลงฐานข้อมูล
