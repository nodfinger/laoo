...
- Responsive Action Header ใช้ breakpoint ที่ Content Area กว้างน้อยกว่า `900px`: Caption อยู่บรรทัดแรก และปุ่ม Action ทั้งหมดอยู่บรรทัดถัดไปโดยชิดซ้ายเสมอ; ตั้งแต่ `900px` ขึ้นไปจึงวาง Caption ซ้ายและปุ่มด้านขวาในบรรทัดเดียวกัน
