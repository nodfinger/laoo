...
class _EmployeeUxPageState extends State<EmployeeUxPage> {
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              if (_canCreate) const SizedBox(width: 8),
              if (_canCreate)
                FilledButton.icon(
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              children: [
                                ...
                                Flexible(
                                  child: Text(
                                    '${row.$5}${row.$6.trim().isEmpty ? '' : ' | ${row.$6}'}',
                                    maxLines: 1,
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (context, setDialogState) => Dialog(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: BorderSide(color: preset.primary, width: 1.2),
          ),
          child: ConstrainedBox(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.delete_forever_outlined, color: accent),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
  ...
  Future<void> _pickStartDate() async {
    ...
    final primary = workspaceThemeController.value.primary;
    final dateColorScheme = theme.colorScheme.copyWith(
      primary: primary,
