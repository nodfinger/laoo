class CompanySetupContext {
  ...
  factory CompanySetupContext.fromJson(Map<String, dynamic> json) {
    return CompanySetupContext(
      ...
      companyName: _nullableText(json['companyName'] ?? json['customerNameTh']),
      addressText: _nullableText(json['addressText']),
      telephone: _nullableText(json['telephone']),
      taxId: _nullableText(json['taxID'] ?? json['taxId']),
      email: _nullableText(json['email'] ?? json['customerEmail']),
    );
  }
