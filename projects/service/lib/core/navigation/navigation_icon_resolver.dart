...
IconData resolveNavigationIcon(
  ...
  return switch (key) {
    ...
    'people' || 'people_outline' || 'people_outlined' || 'groups' ||
    ...
    'shield' || 'shield_outlined' || 'security' || 'security_outlined' =>
