...
IF EXISTS(SELECT 1 FROM dbo.TDSTMasterGroup WHERE Code=N'012' AND Name<>N'ประเภทการประเมิน') THROW 53100,N'MasterGroup 012 conflicts.',1;
IF NOT EXISTS(SELECT 1 FROM dbo.TDSTMasterGroup WHERE Code=N'012') INSERT dbo.TDSTMasterGroup(Code,Name) VALUES(N'012',N'ประเภทการประเมิน');
