...
WHERE G.IsActive = 1
  ...
  AND (M.MenuCode <> N'10006' OR @UserType = N'COMPANY_USER')
  AND (M.MenuCode <> N'01005' OR @UserType = N'LAOO_SUPPORT')
  AND (M.MenuCode <> N'01006' OR @UserType = N'LAOO_SUPPORT')
  AND (
  ...
  AND NOT (@UserType = N'LAOO_SUPPORT' AND G.MenuGroupCode = N'05')
...
""";
        ...
        while (await reader.ReadAsync(cancellationToken))
        {
            ...
            if (admin ||
                (userType == "LAOO_SUPPORT" && (item.MenuCode.Equals("01005", StringComparison.OrdinalIgnoreCase) || item.MenuCode.Equals("01006", StringComparison.OrdinalIgnoreCase))) ||
