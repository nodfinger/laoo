...
class _MeetingRoomPageState extends State<MeetingRoomPage> {
  ...
  final _employeeRepo = MeetingEmployeeDirectoryRepository();
  final _organizationRepo = MeetingOrganizationDirectoryRepository();
  ...
  Future<void> _showRoomRulePopup(
    ...
    try {
      final result = await Future.wait([
        ...
        _employeeRepo.list(isActive: true, page: 1, pageSize: 500),
