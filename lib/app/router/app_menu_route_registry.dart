...
abstract final class AppMenuRouteRegistry {
  static const Map<String, AppMenuRouteSpec> _byMenuCode = {
    ...
    '06003': AppMenuRouteSpec(
      menuCode: '06003',
      databaseRouteName: 'partnerCompanyFeatures',
      goRouteName: RouteNames.partnerCompanyFeatures,
    ...
    '13001': AppMenuRouteSpec(
      menuCode: '13001',
      databaseRouteName: 'salesManagement',
      goRouteName: RouteNames.salesManagement,
      path: RoutePaths.salesManagement,
      scope: AppMenuScope.company,
    ),
