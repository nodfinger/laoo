...
2. ระบบบริการโครงการ — งบประมาณ, เวลา, คน, มอบหมายงาน, ติดตาม, ผลงานและงบจริง
3. ระบบนำทรัพย์สินออกภายนอก — approval, หลักฐานภาพ, serial/จำนวน, จุด รปภ., ติดตามการนำกลับ
4. ระบบ 5S — พื้นที่, ทีมตรวจ, แบบประเมิน/คะแนน และเปรียบเทียบรอบตรวจ
5. ระบบบันทึกค่าใช้จ่าย — เบิกพนักงาน/ค่าใช้จ่ายบริษัท, advance/คืนเงิน, เอกสารแนบ และ reference โครงการ/นำทรัพย์สินออก
6. ระบบแบบสอบถาม — แบบสอบถาม, approval ทางเลือก, ผู้ตอบหลายประเภท, email delivery, tracking และสรุปผล
